...
{
    public partial class SoybeanMDForm : Form
    {
        public SoybeanMDForm()
        {
            InitializeComponent();
        ...
        private void btn_delete_SoyCCD_Click(object sender, EventArgs e)
        {
        ...
        private void btn_Up_SoyCCD_Click(object sender, EventArgs e)
        {
            //可选择多个项目同时上移
            //未选择任何项目
        ...
        private void btn_Down_SoyCCD_Click(object sender, EventArgs e)
        {
            //可选择多个项目同时下移
            //未选择任何项目
            if (listViewCCDImage.SelectedItems.Count == 0)
        ...
        private void btn_delete_SoyIRS_Click(object sender, EventArgs e)
        {
        ...
        private void btn_Up_SoyIRS_Click(object sender, EventArgs e)
        {
            //可选择多个项目同时上移
            //未选择任何项目
        ...
        private void btn_Down_SoyIRS_Click(object sender, EventArgs e)
        {
            //可选择多个项目同时下移
            //未选择任何项目
            if (listViewIRSImage.SelectedItems.Count == 0)
        ...
        private void btn_SoybeanMDoutpath_Click(object sender, EventArgs e)
        {
            ...
            {
                this.txt_SoybeanMDoutpath.Text = folderBrowserDialog1.SelectedPath + "\\MATUREPERIOD_soybean_" + sDatetime + ".tif";
            }
        }
        ...
        {
            string sSoybeanMDoutpath = this.txt_SoybeanMDoutpath.Text.Trim();
            string sPath = Path.GetDirectoryName(sSoybeanMDoutpath);
