...
namespace CropWatchField
{
    public class AggregateToTown
    {
        ...
        /// <returns></returns>
        public static string get_TownValue(String procedure_name, SqlParameter[] param)
        {
            SqlConnection con = DataBaseOperate.getSqlCon();
        ...
        /// <returns></returns>
        public static int insert_Town(String procedure_name, SqlParameter[] param)
        {
            SqlConnection con = DataBaseOperate.getSqlCon();
            SqlCommand cmd = DataBaseOperate.getSqlCmd(procedure_name, con);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        public static string get_SoilTownValue(String procedure_name, SqlParameter[] param)
        {
            SqlConnection con = DataBaseOperate.getSqlCon();
            SqlCommand cmd = DataBaseOperate.getSqlCmd(procedure_name, con);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        /// <param name="SOIL_NUTRIENT"></param>
        /// <returns></returns>
        public static int insert_Town_SOILNUTRIENT(String procedure_name, SqlParameter[] param)
        {
            SqlConnection con = DataBaseOperate.getSqlCon();
            SqlCommand cmd = DataBaseOperate.getSqlCmd(procedure_name, con);
            cmd.CommandType = CommandType.StoredProcedure;
