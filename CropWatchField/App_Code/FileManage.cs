...
namespace CropWatchField
{
    class FileManage
    {
        ...
        public void CreatFoldersBatch(List<string> list, string sPath)
        {
            for (int i = 0; i < list.Count; i++)
            {
                string sName = list[i].ToString();
                string sFolderPath = sPath + sName;
        ...
        /// <param name="sPath"></param>
        public void CreatFolders(string sName, string sPath)
        {
            string sFolderPath = sPath + sName;
            if (!Directory.Exists(sFolderPath))
            {
        ...
        /// </summary>
        /// <param name="list"></param>
        public void CopyListFiles(List<string> list, string sOrignPath, string sDestinationPath)
        {
            for (int i = 0; i < list.Count; i++)
            {
                string sName = list[i].ToString();
                ...
                //原始文件夹
                if (File.Exists(sOrignFile) && !File.Exists(destinationFile))
                {
                    File.Copy(sOrignFile, destinationFile, true);
                }
            }
        }
        ...
        /// </summary>
        /// <param name="list"></param>
        /// <param name="sOrignPath"></param>
        /// <param name="sDestinationPath"></param>
        public void CopySingleFiles(string sName, string sOrignPath, string sDestinationPath)
        {
            //源文件目录
            string sOrignFile = sOrignPath + sName;
            //目标文件目录
        ...
        /// <returns></returns>
        public static List<string> getNewList(List<string> orignList,string sExtensionName)
        {
            ...
            for (int i = 0; i < orignList.Count; i++)
            {
                ...
                for (int j = 0; j < sShortName.Length; j++)
                {
                    sNewName = sShortName[0];
                }
                newlist.Add(sNewName + sExtensionName);
            }
            return newlist;
        }
      ...
      /// <returns></returns>
        ...
        /// <param name="sPath"></param>
        /// <returns></returns>
        public static List<string> getAllFileNameFromFolder(string sPath)
        {
            ...
            foreach (var sFile in sFiles)
            {
                ...
                string sFileName = getFileName(sFile);
                listNames.Add(sFileName);
            }
            return listNames;
        }
        /// <summary>
        ...
        {
            int lastIndex = sFullName.LastIndexOf(@"\");
            string sFileName = sFullName.Substring(lastIndex + 1);
            return sFileName;
        }
