PRO SpecFusionAss,FilenameAss,FilenameRef,OutputPath,QuaKind,QuaArr,Message=Message
  ;Test
;    FilenameAss = 'D:\TestData\SpecFusion\Out\15-hj1b-irs-452-56-20131015_SVR-tif.tif'
;    FilenameRef = 'D:\TestData\SpecFusion\IRS\15-hj1b-irs-452-56-20131015.tif'
;    OutPutPath = 'D:\'
;    QuaKind = 'SpecQua'
...
;      R=DIALOG_MESSAGE(OutputPath)
;      R=DIALOG_MESSAGE(OutFileName)
      ;
