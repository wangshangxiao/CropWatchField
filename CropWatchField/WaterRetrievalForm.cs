...
{
    public partial class WaterRetrievalForm : Form
    {
        public WaterRetrievalForm()
        {
            InitializeComponent();
            ComBoxDataBind();
        ...
        /// <param name="e"></param>
        private void btn_Watertableinpath_Click(object sender, EventArgs e)
        {
            ...
            {
                this.txt_WatertableInpath.Text = dlg.FileName;
            }
        }
        /// <summary>
        ...
        private void btn_Up_IRS_Click(object sender, EventArgs e)
        {
            //可选择多个项目同时上移
            //未选择任何项目
        ...
        private void btn_Down_IRS_Click(object sender, EventArgs e)
        {
            //可选择多个项目同时下移
            //未选择任何项目
            if (listViewImage.SelectedItems.Count == 0)
        ...
        private void btn_WaterImageOutPath_Click(object sender, EventArgs e)
        {
            ...
            {
                this.txt_WaterImageOutPath.Text = folderBrowserDialog1.SelectedPath + "\\WaterRetrieval_"+scbx_CropType+"_" + sDatetime + ".tif";
            }
        }
        ...
        {
            string sWaterImageOutPath = this.txt_WaterImageOutPath.Text.Trim();
            string sPath = Path.GetDirectoryName(sWaterImageOutPath);
