...
{
    public partial class SoilAggregateToVillage : Form
    {
        public SoilAggregateToVillage()
        {
            InitializeComponent();
        }

        //用来展示结果的datatable,最终绑定到datagridview上
        DataTable dt = AggregateToVillage.CreateSoilDatatable();
        //处在选择的时间范围内的天数
        int date_count = 0;
        //获取具体的时间列表
        ...
        int VillageCount = 0;
        //获取具体的VillageCode
        List<string> VillageCode_list = null;
        //获取CropCount
        int CropCount = 0;
        //获取具体的CropCode
