...
{
    public partial class AggregateToCountyForm : Form
    {
        public AggregateToCountyForm()
        {
            InitializeComponent();
        }

         //用来展示结果的datatable,最终绑定到datagridview上
        DataTable dt =AggregateToCounty.CreateDatatable();
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                switch (lbl_tablename.Text)
                {
                    case "WATERRETRIEVAL":
                        ...
                        reslut =AggregateToCounty.insert_County("insert_County_WATERRETRIEVAL", param);
                        break;
                    case "CHLOROPHYLLRETRIEVAL":
                        param = new SqlParameter[] {
                                new SqlParameter("@COUNTYCODE",CountyCode),
                        ...
                        reslut = AggregateToCounty.insert_County("insert_County_CHLOROPHYLLRETRIEVAL", param);
                        break;
                    case "CROPYIELD":
                        param = new SqlParameter[] {
                                new SqlParameter("@COUNTYCODE",CountyCode),
                        ...
                        reslut = AggregateToCounty.insert_County("insert_County_CROPYIELD", param);
                        break;
                    case "MATUREPERIOD":
                        param = new SqlParameter[] {
                                new SqlParameter("@COUNTYCODE",CountyCode),
                        ...
                        reslut = AggregateToCounty.insert_County("insert_County_MATUREPERIOD", param);
                        break;
                }
            }
            if (reslut > 0)
