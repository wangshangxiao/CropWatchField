             ...
             for (int i = 0; i < dt.Columns.Count; i++)
             {
                 switch (dt.Columns[i].ColumnName)
                 {
                     ...
                     case "NUTRIENT_CODE":
                         ...
                         break;
                     case "WATERVALUE":
                         dt.Columns[i].ColumnName = "作物冠层水分含量";
                         break;
                     case "SOIL_NUTRIENT":
                         dt.Columns[i].ColumnName = "土壤养分";
                         break;
                     case "MATURE_PERIOD":
                         dt.Columns[i].ColumnName = "作物成熟期";
                         break;
                     case "CROP_YIELD":
                         dt.Columns[i].ColumnName = "作物单产";
                         break;
                     case "CHLOROPHYLLVALUE":
                         dt.Columns[i].ColumnName = "叶绿素含量";
                         break;
                 }
             }
             return dt;
